...
# Creating keys - using a helper script packaged as sbkeys
...
# Signing EFI binaries with a pacman hook
...
# Enrolling keys in firmware using sbkeysync
...
# Verifying the changes - sbkeysync will make to the system's UEFI keystore
